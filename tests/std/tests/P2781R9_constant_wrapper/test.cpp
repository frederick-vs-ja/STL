...
namespace AdlTest3 {
    struct NonConst {
        ...
        Assign operator=(const NonConst& other) const {
            return {other.val_};
        }
    };
} // namespace AdlTest3
...
constexpr bool test() {
    ...
    // operator()
    {
        ...
        (void) constant_wrapper<PlusYesexcept{}>::operator()(cw<42>, cw<17>);
        ...
        [[maybe_unused]] same_as<constant_wrapper<ReturnTypeTester::InvocationResult<int>{}>> decltype(auto) cw3 =
            cw<ReturnTypeTester{}>(std::cw<1729>);
    }
...
void test_nonconstexpr() {
    ...
    // The following cases contain undefined behavior and thus should not be executed.
#ifdef __clang__
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Winteger-overflow"
#endif
    if (false) {
#if defined(__clang__) || defined(__EDG__) // TRANSITION, DevCom-11143158
        [[maybe_unused]] same_as<int> decltype(auto) v1 = -cw<numeric_limits<int>::min()>;
#endif // ^^^ no workaround ^^^
        [[maybe_unused]] same_as<int> decltype(auto) v2 = cw<numeric_limits<int>::max()> + cw<42>;
        [[maybe_unused]] same_as<int> decltype(auto) v3 = cw<numeric_limits<int>::min()> - cw<1729>;
        [[maybe_unused]] same_as<int> decltype(auto) v4 = cw<numeric_limits<int>::max()> * cw<42>;
        [[maybe_unused]] same_as<int> decltype(auto) v5 = cw<numeric_limits<int>::min()> / cw<-1>;
        [[maybe_unused]] same_as<int> decltype(auto) v6 = cw<42> / cw<0>;
#ifndef __EDG__ // TRANSITION
        [[maybe_unused]] same_as<int> decltype(auto) v7           = cw<numeric_limits<int>::min()> % cw<-1>;
        [[maybe_unused]] same_as<unsigned int> decltype(auto) v8  = cw<42u> << cw<numeric_limits<unsigned int>::digits>;
        [[maybe_unused]] same_as<unsigned int> decltype(auto) v9  = cw<42u> >> cw<numeric_limits<unsigned int>::digits>;
        [[maybe_unused]] same_as<unsigned int> decltype(auto) v10 = cw<42u> << cw<-1>;
        [[maybe_unused]] same_as<unsigned int> decltype(auto) v11 = cw<42u> >> cw<-1>;
#endif

        [[maybe_unused]] same_as<int&> decltype(auto) v12        = *cw<static_cast<int*>(nullptr)>;
        [[maybe_unused]] same_as<int*> decltype(auto) v13        = cw<static_cast<int*>(nullptr)> + cw<2U>;
        [[maybe_unused]] same_as<long*> decltype(auto) v14       = cw<static_cast<long*>(nullptr)> - cw<2>;
        [[maybe_unused]] same_as<int> decltype(auto) v15         = cw<static_cast<int (*)(int)>(nullptr)>(cw<1729>);
        [[maybe_unused]] same_as<const char&> decltype(auto) v16 = cw<static_cast<const char*>(nullptr)>[cw<1LL>];
        [[maybe_unused]] same_as<const int&> decltype(auto) v17  = cw<i_array>[cw<42L>];
    }
#ifdef __clang__
