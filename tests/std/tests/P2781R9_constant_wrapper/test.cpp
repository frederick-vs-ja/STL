...
#ifdef __clang__ // TRANSITION, DevCom-11151627
template <class T>
concept CanUnaryAnd = requires(T&& t) { &static_cast<T&&>(t); };
#else // ^^^ no workaround / workaround vvv
template <class, class = void>
constexpr bool CanUnaryAnd = false;
template <class T>
constexpr bool CanUnaryAnd<T, void_t<decltype(&declval<T>())>> = true;
#endif // ^^^ workaround ^^^
...
template <class T, class U>
concept CanThreeWay = requires(T t, U u) { t <=> u; };
...
namespace AdlTest {
    struct S {
        ...
        friend constexpr UnequalRightInt operator!=(S m, int n) {
            return {m.val_ != n};
        }
        ...
        friend constexpr GreaterEqual operator>=(S m, S n) {
            return {m.val_ >= n.val_};
        }
        friend constexpr GreaterEqualLeftInt operator>=(int m, S n) {
            return {m >= n.val_};
        }
        friend constexpr GreaterEqualRightInt operator>=(S m, int n) {
            return {m.val_ >= n};
        }
...
namespace AdlTest3 {
    struct NonConst {
        ...
        // Operators are intentionally non-noexcept and noexcept(false).

        struct UnaryPlus {
            int res_;
        };

        friend UnaryPlus operator+(NonConst s) {
            return {s.val_};
        }
        ...
        friend UnaryMinus operator-(NonConst s) {
            return {-s.val_};
        }
        ...
        friend Complement operator~(NonConst s) {
            return {~s.val_};
        }
        ...
        friend Negate operator!(NonConst s) {
            return {!s.val_};
        }
        ...
        friend DerefCopy operator*(NonConst s) {
            return {s.val_};
        }
        ...
        friend UnaryAnd operator&(const NonConst& s) {
            return {&s.val_};
        }
        ...
        friend Plus operator+(NonConst m, NonConst n) {
            return {m.val_ + n.val_};
        }
        ...
        friend Minus operator-(NonConst m, NonConst n) {
            return {m.val_ - n.val_};
        }
        ...
        friend Multiply operator*(NonConst m, NonConst n) {
            return {m.val_ * n.val_};
        }
        ...
        friend Divide operator/(NonConst m, NonConst n) {
            return {m.val_ / n.val_};
        }
        ...
        friend Modulo operator%(NonConst m, NonConst n) {
            return {m.val_ % n.val_};
        }
        ...
        friend Shl operator<<(NonConst m, NonConst n) {
            return {m.val_ << n.val_};
        }
        ...
        friend Shr operator>>(NonConst m, NonConst n) {
            return {m.val_ >> n.val_};
        }
        ...
        friend BitAnd operator&(NonConst m, NonConst n) {
            return {m.val_ & n.val_};
        }
        ...
        friend BitOr operator|(NonConst m, NonConst n) {
            return {m.val_ | n.val_};
        }
        ...
        friend Xor operator^(NonConst m, NonConst n) {
            return {m.val_ ^ n.val_};
        }
        ...
        friend LogicalAnd operator&&(NonConst m, NonConst n) {
            return {m.val_ && n.val_};
        }
        ...
        friend LogicalOr operator||(NonConst m, NonConst n) {
            return {m.val_ || n.val_};
        }
        ...
        struct ThreeWayCmp {
            strong_ordering res_;
        };

        friend ThreeWayCmp operator<=>(NonConst m, NonConst n) {
            return {m.val_ <=> n.val_};
        }
        ...
        friend Less operator<(NonConst m, NonConst n) {
            return {m.val_ < n.val_};
        }
        ...
        friend LessEqual operator<=(NonConst m, NonConst n) {
            return {m.val_ <= n.val_};
        }
        ...
        friend Equal operator==(NonConst m, NonConst n) {
            return {m.val_ == n.val_};
        }
        ...
        friend Unequal operator!=(NonConst m, NonConst n) {
            return {m.val_ != n.val_};
        }
        ...
        friend Greater operator>(NonConst m, NonConst n) {
            return {m.val_ > n.val_};
        }
        ...
        friend GreaterEqual operator>=(NonConst m, NonConst n) {
            return {m.val_ >= n.val_};
        }
        ...
        friend ArrowStar operator->*(NonConst m, NonConst n) {
            return {-(m.val_ * n.val_)};
        }
        ...
        friend PreInc operator++(NonConst s) {
            return {s.val_ + 1};
        }
        ...
        friend PostInc operator++(NonConst s, int) {
            return {s.val_ + 1};
        }
        ...
        friend PreDec operator--(NonConst s) {
            return {s.val_ - 1};
        }
        ...
        friend PostDec operator--(NonConst s, int) {
            return {s.val_ - 1};
        }
        ...
        friend PlusAssign operator+=(NonConst m, NonConst n) {
            return {m.val_ + n.val_};
        }
        ...
        friend MinusAssign operator-=(NonConst m, NonConst n) {
            return {m.val_ - n.val_};
        }
        ...
        friend MultiplyAssign operator*=(NonConst m, NonConst n) {
            return {m.val_ * n.val_};
        }
        ...
        friend DivideAssign operator/=(NonConst m, NonConst n) {
            return {m.val_ / n.val_};
        }
        ...
        friend ModuloAssign operator%=(NonConst m, NonConst n) {
            return {m.val_ % n.val_};
        }
        ...
        friend ShlAssign operator<<=(NonConst m, NonConst n) {
            return {m.val_ << n.val_};
        }
        ...
        friend ShrAssign operator>>=(NonConst m, NonConst n) {
            return {m.val_ >> n.val_};
        }
        ...
        friend BitAndAssign operator&=(NonConst m, NonConst n) {
            return {m.val_ & n.val_};
        }
        ...
        friend BitOrAssign operator|=(NonConst m, NonConst n) {
            return {m.val_ | n.val_};
        }
        ...
        friend XorAssign operator^=(NonConst m, NonConst n) {
            return {m.val_ ^ n.val_};
        }
    };
} // namespace AdlTest3
...
struct ReturnTypeTester {
    ...
    template <class T>
    static constexpr auto operator()(T) -> InvocationResult<T> {
        return {};
    }

    template <class T>
    static constexpr auto operator[](T) -> SubscriptResult<T> {
        return {};
    }
};
...
struct PlusLike {
    template <class T, class U>
    static constexpr auto operator()(T&& t, U&& u) noexcept(IsNoexcept)
...
using PlusNoexcept  = PlusLike<true>;
using PlusYesexcept = PlusLike<false>;

template <class T, size_t N, bool IsNoexcept>
struct ArrayLike {
    T elems_[N];

    constexpr T& operator[](size_t i) noexcept(IsNoexcept) {
        return elems_[i];
    }
    constexpr const T& operator[](size_t i) const noexcept(IsNoexcept) {
        return elems_[i];
    }
};

template <class T, size_t N>
using ArrayNoexcept = ArrayLike<T, N, true>;
template <class T, size_t N>
using ArrayYesexcept = ArrayLike<T, N, false>;
...
constexpr bool test() {
...
#ifndef __EDG__ // TRANSITION, DevCom-11152532
    ...
    // unary operator&
    {
        ...
        static_assert(CanUnaryAnd<constant_wrapper<S{1729}>>);
        static_assert(CanUnaryAnd<constant_wrapper<NoOperation{}>>);
#ifndef __EDG__ // TRANSITION, DevCom-11152093
        static_assert(!CanUnaryAnd<constant_wrapper<UsualNonaddressable{}>>);
#endif // ^^^ no workaround ^^^
        static_assert(!CanUnaryAnd<constant_wrapper<Nonaddressable{}>>);
...
#ifndef __EDG__ // TRANSITION, fixed in EDG 6.9
    ...
    // operator<=>
    {
        static_assert(CanThreeWay<constant_wrapper<0>, long>);
        static_assert(CanThreeWay<int, constant_wrapper<1L>>);
        static_assert(CanThreeWay<constant_wrapper<2U>, constant_wrapper<3ULL>>);
        static_assert(CanThreeWay<constant_wrapper<0.0F>, long>);
        static_assert(CanThreeWay<float, constant_wrapper<1.0>>);
        static_assert(CanThreeWay<constant_wrapper<2.0L>, constant_wrapper<3LL>>);
        static_assert(!CanThreeWay<constant_wrapper<0>, nullptr_t>);
        static_assert(!CanThreeWay<char, constant_wrapper<i_array>>);
        static_assert(!CanThreeWay<constant_wrapper<i_mut_array>, constant_wrapper<U'\u3000'>>);
        static_assert(!CanThreeWay<constant_wrapper<noop_fun>, constant_wrapper<noop_noexcept_fun>>);
        static_assert(CanThreeWay<constant_wrapper<S{-17}>, constant_wrapper<S{29}>>);
        static_assert(CanThreeWay<constant_wrapper<S{94}>, constant_wrapper<S{94}>>);
        static_assert(CanThreeWay<constant_wrapper<S{1729}>, constant_wrapper<S{42}>>);
        static_assert(CanThreeWay<constant_wrapper<-17>, constant_wrapper<S{29}>>);
        static_assert(CanThreeWay<constant_wrapper<94>, constant_wrapper<S{94}>>);
        static_assert(CanThreeWay<constant_wrapper<1729>, constant_wrapper<S{42}>>);
        static_assert(CanThreeWay<constant_wrapper<S{-17}>, constant_wrapper<29>>);
        static_assert(CanThreeWay<constant_wrapper<S{94}>, constant_wrapper<94>>);
        static_assert(CanThreeWay<constant_wrapper<S{1729}>, constant_wrapper<42>>);

        static_assert(noexcept(cw<0> <=> 1L));
        static_assert(noexcept(123 <=> cw<1L>));
        static_assert(noexcept(cw<2U> <=> cw<3LL>));
        static_assert(noexcept(cw<0.0F> <=> -2L));
        static_assert(noexcept(1.0F <=> cw<1.0>));
        static_assert(noexcept(cw<2.0L> <=> cw<3LL>));

        same_as<strong_ordering> decltype(auto) v1  = cw<0> <=> 1L;
        same_as<strong_ordering> decltype(auto) v2  = 123 <=> cw<1L>;
        same_as<partial_ordering> decltype(auto) v3 = cw<0.0F> <=> -2L;
        same_as<partial_ordering> decltype(auto) v4 = 1.0F <=> cw<1.0>;

        assert(v1 == strong_ordering::less);
        assert(v2 == strong_ordering::greater);
        assert(v3 == partial_ordering::greater);
        assert(v4 == partial_ordering::equivalent);

        // When X <=> Y normally returns a comparison category value,
        // the type of cw<X> <=> cw<Y> is controversial because comparison category types may be structural or not.
        // So this test file skips the common cases.

        [[maybe_unused]] same_as<constant_wrapper<S::ThreeWayCmp{-1}>> decltype(auto) cw1 = cw<S{-17}> <=> cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::ThreeWayCmp{0}>> decltype(auto) cw2  = cw<S{94}> <=> cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::ThreeWayCmp{1}>> decltype(auto) cw3  = cw<S{1729}> <=> cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::ThreeWayCmpLeftInt{-1}>> decltype(auto) cw4 =
            cw<-17> <=> cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::ThreeWayCmpLeftInt{0}>> decltype(auto) cw5 = cw<94> <=> cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::ThreeWayCmpLeftInt{1}>> decltype(auto) cw6 =
            cw<1729> <=> cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::ThreeWayCmpRightInt{-1}>> decltype(auto) cw7 =
            cw<S{-17}> <=> cw<29>;
        [[maybe_unused]] same_as<constant_wrapper<S::ThreeWayCmpRightInt{0}>> decltype(auto) cw8 = cw<S{94}> <=> cw<94>;
        [[maybe_unused]] same_as<constant_wrapper<S::ThreeWayCmpRightInt{1}>> decltype(auto) cw9 =
            cw<S{1729}> <=> cw<42>;
    }
    ...
    // operator<
    {
        ...
        static_assert(CanLess<const int*, constant_wrapper<i_array>>);
        ...
        same_as<bool> decltype(auto) v1  = cw<u'\u0000'> < 42U;
        same_as<bool> decltype(auto) v2  = cw<u'*'> < static_cast<unsigned short>(42U);
        same_as<bool> decltype(auto) v3  = cw<u'~'> < 42ULL;
        same_as<bool> decltype(auto) v4  = static_cast<unsigned char>(42U) < cw<u'\u0000'>;
        same_as<bool> decltype(auto) v5  = 42U < cw<u'*'>;
        same_as<bool> decltype(auto) v6  = 42UL < cw<u'~'>;
        same_as<bool> decltype(auto) v7  = cw<42> < 40.0F;
        same_as<bool> decltype(auto) v8  = 72.5 < cw<84.0F>;
        same_as<bool> decltype(auto) v9  = cw<i_array> < i_array;
        same_as<bool> decltype(auto) v10 = cw<i_array> < i_array + 1;
        same_as<bool> decltype(auto) v11 = i_array < cw<i_array + 1>;
        same_as<bool> decltype(auto) v12 = i_array + 1 < cw<i_array>;
        ...
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw1          = cw<1234.5> < cw<123.0L>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw2           = cw<i_array> < cw<i_array + 1>;
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw3          = cw<i_array> < cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw4          = cw<i_array + 1> < cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<S::Less{true}>> decltype(auto) cw5  = cw<S{-17}> < cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::Less{false}>> decltype(auto) cw6 = cw<S{94}> < cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::Less{false}>> decltype(auto) cw7 = cw<S{1729}> < cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessLeftInt{true}>> decltype(auto) cw8    = cw<-17> < cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessLeftInt{false}>> decltype(auto) cw9   = cw<94> < cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessLeftInt{false}>> decltype(auto) cw10  = cw<1729> < cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessRightInt{true}>> decltype(auto) cw11  = cw<S{-17}> < cw<29>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessRightInt{false}>> decltype(auto) cw12 = cw<S{94}> < cw<94>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessRightInt{false}>> decltype(auto) cw13 = cw<S{1729}> < cw<42>;
    }

    // operator<=
    {
        static_assert(CanLessEqual<constant_wrapper<u'\u0000'>, unsigned int>);
        static_assert(CanLessEqual<constant_wrapper<u'*'>, unsigned short>);
        static_assert(CanLessEqual<constant_wrapper<u'~'>, unsigned long long>);
        static_assert(CanLessEqual<unsigned char, constant_wrapper<u'\u0000'>>);
        static_assert(CanLessEqual<unsigned int, constant_wrapper<u'*'>>);
        static_assert(CanLessEqual<unsigned long, constant_wrapper<u'~'>>);
        static_assert(CanLessEqual<constant_wrapper<u'\u0000'>, constant_wrapper<42U>>);
        static_assert(CanLessEqual<constant_wrapper<u'*'>, constant_wrapper<static_cast<unsigned short>(42U)>>);
        static_assert(CanLessEqual<constant_wrapper<u'~'>, constant_wrapper<42ULL>>);
        static_assert(CanLessEqual<constant_wrapper<static_cast<unsigned char>(42U)>, constant_wrapper<u'\u0000'>>);
        static_assert(CanLessEqual<constant_wrapper<42U>, constant_wrapper<u'*'>>);
        static_assert(CanLessEqual<constant_wrapper<42UL>, constant_wrapper<u'~'>>);
        static_assert(CanLessEqual<constant_wrapper<42>, float>);
        static_assert(CanLessEqual<double, constant_wrapper<84.0F>>);
        static_assert(CanLessEqual<constant_wrapper<1234.5>, constant_wrapper<123.0L>>);
        static_assert(!CanLessEqual<constant_wrapper<i_mut_array>, char>);
        static_assert(!CanLessEqual<int, constant_wrapper<nullptr>>);
        static_assert(!CanLessEqual<constant_wrapper<i_array>, constant_wrapper<noop_fun>>);
        static_assert(CanLessEqual<constant_wrapper<i_array>, const int*>);
        static_assert(CanLessEqual<const int*, constant_wrapper<i_array>>);
        static_assert(CanLessEqual<const int*, constant_wrapper<i_array + 1>>);
        static_assert(CanLessEqual<constant_wrapper<i_array>, constant_wrapper<i_array + 1>>);
        static_assert(CanLessEqual<constant_wrapper<i_array>, constant_wrapper<i_array>>);
        static_assert(CanLessEqual<constant_wrapper<i_array + 1>, constant_wrapper<i_array>>);
        static_assert(CanLessEqual<constant_wrapper<S{-17}>, constant_wrapper<S{29}>>);
        static_assert(CanLessEqual<constant_wrapper<S{94}>, constant_wrapper<S{94}>>);
        static_assert(CanLessEqual<constant_wrapper<S{1729}>, constant_wrapper<S{42}>>);
        static_assert(CanLessEqual<constant_wrapper<-17>, constant_wrapper<S{29}>>);
        static_assert(CanLessEqual<constant_wrapper<94>, constant_wrapper<S{94}>>);
        static_assert(CanLessEqual<constant_wrapper<1729>, constant_wrapper<S{42}>>);
        static_assert(CanLessEqual<constant_wrapper<S{-17}>, constant_wrapper<29>>);
        static_assert(CanLessEqual<constant_wrapper<S{94}>, constant_wrapper<94>>);
        static_assert(CanLessEqual<constant_wrapper<S{1729}>, constant_wrapper<42>>);
        ...
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw1 = cw<1234.5> <= cw<123.0L>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw2  = cw<i_array> <= cw<i_array + 1>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw3  = cw<i_array> <= cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw4 = cw<i_array + 1> <= cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessEqual{true}>> decltype(auto) cw5  = cw<S{-17}> <= cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessEqual{true}>> decltype(auto) cw6  = cw<S{94}> <= cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessEqual{false}>> decltype(auto) cw7 = cw<S{1729}> <= cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessEqualLeftInt{true}>> decltype(auto) cw8 = cw<-17> <= cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessEqualLeftInt{true}>> decltype(auto) cw9 = cw<94> <= cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessEqualLeftInt{false}>> decltype(auto) cw10 =
            cw<1729> <= cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessEqualRightInt{true}>> decltype(auto) cw11 =
            cw<S{-17}> <= cw<29>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessEqualRightInt{true}>> decltype(auto) cw12 =
            cw<S{94}> <= cw<94>;
        [[maybe_unused]] same_as<constant_wrapper<S::LessEqualRightInt{false}>> decltype(auto) cw13 =
            cw<S{1729}> <= cw<42>;
    }

    // operator==
    {
        static_assert(CanEqual<constant_wrapper<u'\u0000'>, unsigned int>);
        static_assert(CanEqual<constant_wrapper<u'*'>, unsigned short>);
        static_assert(CanEqual<constant_wrapper<u'~'>, unsigned long long>);
        static_assert(CanEqual<unsigned char, constant_wrapper<u'\u0000'>>);
        static_assert(CanEqual<unsigned int, constant_wrapper<u'*'>>);
        static_assert(CanEqual<unsigned long, constant_wrapper<u'~'>>);
        static_assert(CanEqual<constant_wrapper<u'\u0000'>, constant_wrapper<42U>>);
        static_assert(CanEqual<constant_wrapper<u'*'>, constant_wrapper<static_cast<unsigned short>(42U)>>);
        static_assert(CanEqual<constant_wrapper<u'~'>, constant_wrapper<42ULL>>);
        static_assert(CanEqual<constant_wrapper<static_cast<unsigned char>(42U)>, constant_wrapper<u'\u0000'>>);
        static_assert(CanEqual<constant_wrapper<42U>, constant_wrapper<u'*'>>);
        static_assert(CanEqual<constant_wrapper<42UL>, constant_wrapper<u'~'>>);
        static_assert(CanEqual<constant_wrapper<42>, float>);
        static_assert(CanEqual<double, constant_wrapper<84.0F>>);
        static_assert(CanEqual<constant_wrapper<1234.5>, constant_wrapper<123.0L>>);
        static_assert(!CanEqual<constant_wrapper<i_mut_array>, char>);
        static_assert(!CanEqual<int, constant_wrapper<nullptr>>);
        static_assert(!CanEqual<constant_wrapper<i_array>, constant_wrapper<noop_fun>>);
        static_assert(CanEqual<constant_wrapper<i_array>, const int*>);
        static_assert(CanEqual<const int*, constant_wrapper<i_array>>);
        static_assert(CanEqual<const int*, constant_wrapper<i_array + 1>>);
        static_assert(CanEqual<constant_wrapper<i_array>, constant_wrapper<i_array + 1>>);
        static_assert(CanEqual<constant_wrapper<i_array>, constant_wrapper<i_array>>);
        static_assert(CanEqual<constant_wrapper<i_array + 1>, constant_wrapper<i_array>>);
        static_assert(CanEqual<constant_wrapper<noop_fun>, void (*)() noexcept>);
        static_assert(CanEqual<void (*)(), constant_wrapper<noop_noexcept_fun>>);
        static_assert(CanEqual<constant_wrapper<noop_fun>, constant_wrapper<noop_fun>>);
        static_assert(CanEqual<constant_wrapper<noop_noexcept_fun>, constant_wrapper<noop_fun>>);
        static_assert(CanEqual<constant_wrapper<S{-17}>, constant_wrapper<S{29}>>);
        static_assert(CanEqual<constant_wrapper<S{94}>, constant_wrapper<S{94}>>);
        static_assert(CanEqual<constant_wrapper<S{1729}>, constant_wrapper<S{42}>>);
        static_assert(CanEqual<constant_wrapper<-17>, constant_wrapper<S{29}>>);
        static_assert(CanEqual<constant_wrapper<94>, constant_wrapper<S{94}>>);
        static_assert(CanEqual<constant_wrapper<1729>, constant_wrapper<S{42}>>);
        static_assert(CanEqual<constant_wrapper<S{-17}>, constant_wrapper<29>>);
        static_assert(CanEqual<constant_wrapper<S{94}>, constant_wrapper<94>>);
        static_assert(CanEqual<constant_wrapper<S{1729}>, constant_wrapper<42>>);
        ...
        static_assert(noexcept(cw<i_array> == cw<i_array>));
        static_assert(noexcept(cw<i_array + 1> == cw<i_array>));
        static_assert(noexcept(cw<noop_fun> == noop_noexcept_fun));
        static_assert(noexcept(&noop_fun == cw<noop_noexcept_fun>));
        static_assert(noexcept(cw<noop_fun> == cw<noop_fun>));
        static_assert(noexcept(cw<noop_noexcept_fun> == cw<noop_fun>));
        static_assert(noexcept(cw<S{-17}> == cw<S{29}>));
        static_assert(noexcept(cw<S{94}> == cw<S{94}>));
        static_assert(noexcept(cw<S{1729}> == cw<S{42}>));
        static_assert(noexcept(cw<-17> == cw<S{29}>));
        ...
        same_as<bool> decltype(auto) v11 = i_array == cw<i_array + 1>;
        same_as<bool> decltype(auto) v12 = i_array + 1 == cw<i_array>;
        same_as<bool> decltype(auto) v13 = cw<noop_fun> == noop_noexcept_fun;
        same_as<bool> decltype(auto) v14 = &noop_fun == cw<noop_noexcept_fun>;
        ...
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw1 = cw<1234.5> == cw<123.0L>;
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw2 = cw<i_array> == cw<i_array + 1>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw3  = cw<i_array> == cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw4 = cw<i_array + 1> == cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw5  = cw<noop_fun> == cw<noop_fun>;
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw6 = cw<noop_noexcept_fun> == cw<noop_fun>;
        [[maybe_unused]] same_as<constant_wrapper<S::Equal{false}>> decltype(auto) cw7 = cw<S{-17}> == cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::Equal{true}>> decltype(auto) cw8  = cw<S{94}> == cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::Equal{false}>> decltype(auto) cw9 = cw<S{1729}> == cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::EqualLeftInt{false}>> decltype(auto) cw10  = cw<-17> == cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::EqualLeftInt{true}>> decltype(auto) cw11   = cw<94> == cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::EqualLeftInt{false}>> decltype(auto) cw12  = cw<1729> == cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::EqualRightInt{false}>> decltype(auto) cw13 = cw<S{-17}> == cw<29>;
        [[maybe_unused]] same_as<constant_wrapper<S::EqualRightInt{true}>> decltype(auto) cw14  = cw<S{94}> == cw<94>;
        [[maybe_unused]] same_as<constant_wrapper<S::EqualRightInt{false}>> decltype(auto) cw15 = cw<S{1729}> == cw<42>;
    }

    // operator!=
    {
        static_assert(CanUnequal<constant_wrapper<u'\u0000'>, unsigned int>);
        static_assert(CanUnequal<constant_wrapper<u'*'>, unsigned short>);
        static_assert(CanUnequal<constant_wrapper<u'~'>, unsigned long long>);
        static_assert(CanUnequal<unsigned char, constant_wrapper<u'\u0000'>>);
        static_assert(CanUnequal<unsigned int, constant_wrapper<u'*'>>);
        static_assert(CanUnequal<unsigned long, constant_wrapper<u'~'>>);
        static_assert(CanUnequal<constant_wrapper<u'\u0000'>, constant_wrapper<42U>>);
        static_assert(CanUnequal<constant_wrapper<u'*'>, constant_wrapper<static_cast<unsigned short>(42U)>>);
        static_assert(CanUnequal<constant_wrapper<u'~'>, constant_wrapper<42ULL>>);
        static_assert(CanUnequal<constant_wrapper<static_cast<unsigned char>(42U)>, constant_wrapper<u'\u0000'>>);
        static_assert(CanUnequal<constant_wrapper<42U>, constant_wrapper<u'*'>>);
        static_assert(CanUnequal<constant_wrapper<42UL>, constant_wrapper<u'~'>>);
        static_assert(CanUnequal<constant_wrapper<42>, float>);
        static_assert(CanUnequal<double, constant_wrapper<84.0F>>);
        static_assert(CanUnequal<constant_wrapper<1234.5>, constant_wrapper<123.0L>>);
        static_assert(!CanUnequal<constant_wrapper<i_mut_array>, char>);
        static_assert(!CanUnequal<int, constant_wrapper<nullptr>>);
        static_assert(!CanUnequal<constant_wrapper<i_array>, constant_wrapper<noop_fun>>);
        static_assert(CanUnequal<constant_wrapper<i_array>, const int*>);
        static_assert(CanUnequal<const int*, constant_wrapper<i_array>>);
        static_assert(CanUnequal<const int*, constant_wrapper<i_array + 1>>);
        static_assert(CanUnequal<constant_wrapper<i_array>, constant_wrapper<i_array + 1>>);
        static_assert(CanUnequal<constant_wrapper<i_array>, constant_wrapper<i_array>>);
        static_assert(CanUnequal<constant_wrapper<i_array + 1>, constant_wrapper<i_array>>);
        static_assert(CanUnequal<constant_wrapper<noop_fun>, void (*)() noexcept>);
        static_assert(CanUnequal<void (*)(), constant_wrapper<noop_noexcept_fun>>);
        static_assert(CanUnequal<constant_wrapper<noop_fun>, constant_wrapper<noop_fun>>);
        static_assert(CanUnequal<constant_wrapper<noop_noexcept_fun>, constant_wrapper<noop_fun>>);
        static_assert(CanUnequal<constant_wrapper<S{-17}>, constant_wrapper<S{29}>>);
        static_assert(CanUnequal<constant_wrapper<S{94}>, constant_wrapper<S{94}>>);
        static_assert(CanUnequal<constant_wrapper<S{1729}>, constant_wrapper<S{42}>>);
        static_assert(CanUnequal<constant_wrapper<-17>, constant_wrapper<S{29}>>);
        static_assert(CanUnequal<constant_wrapper<94>, constant_wrapper<S{94}>>);
        static_assert(CanUnequal<constant_wrapper<1729>, constant_wrapper<S{42}>>);
        static_assert(CanUnequal<constant_wrapper<S{-17}>, constant_wrapper<29>>);
        static_assert(CanUnequal<constant_wrapper<S{94}>, constant_wrapper<94>>);
        static_assert(CanUnequal<constant_wrapper<S{1729}>, constant_wrapper<42>>);
        ...
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw1  = cw<1234.5> != cw<123.0L>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw2  = cw<i_array> != cw<i_array + 1>;
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw3 = cw<i_array> != cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw4  = cw<i_array + 1> != cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw5 = cw<noop_fun> != cw<noop_fun>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw6  = cw<noop_noexcept_fun> != cw<noop_fun>;
        [[maybe_unused]] same_as<constant_wrapper<S::Unequal{true}>> decltype(auto) cw7  = cw<S{-17}> != cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::Unequal{false}>> decltype(auto) cw8 = cw<S{94}> != cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::Unequal{true}>> decltype(auto) cw9  = cw<S{1729}> != cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::UnequalLeftInt{true}>> decltype(auto) cw10  = cw<-17> != cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::UnequalLeftInt{false}>> decltype(auto) cw11 = cw<94> != cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::UnequalLeftInt{true}>> decltype(auto) cw12 = cw<1729> != cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::UnequalRightInt{true}>> decltype(auto) cw13 = cw<S{-17}> != cw<29>;
        [[maybe_unused]] same_as<constant_wrapper<S::UnequalRightInt{false}>> decltype(auto) cw14 = cw<S{94}> != cw<94>;
        [[maybe_unused]] same_as<constant_wrapper<S::UnequalRightInt{true}>> decltype(auto) cw15 =
            cw<S{1729}> != cw<42>;
    }

    // operator>
    {
        static_assert(CanGreater<constant_wrapper<u'\u0000'>, unsigned int>);
        static_assert(CanGreater<constant_wrapper<u'*'>, unsigned short>);
        static_assert(CanGreater<constant_wrapper<u'~'>, unsigned long long>);
        static_assert(CanGreater<unsigned char, constant_wrapper<u'\u0000'>>);
        static_assert(CanGreater<unsigned int, constant_wrapper<u'*'>>);
        static_assert(CanGreater<unsigned long, constant_wrapper<u'~'>>);
        static_assert(CanGreater<constant_wrapper<u'\u0000'>, constant_wrapper<42U>>);
        static_assert(CanGreater<constant_wrapper<u'*'>, constant_wrapper<static_cast<unsigned short>(42U)>>);
        static_assert(CanGreater<constant_wrapper<u'~'>, constant_wrapper<42ULL>>);
        static_assert(CanGreater<constant_wrapper<static_cast<unsigned char>(42U)>, constant_wrapper<u'\u0000'>>);
        static_assert(CanGreater<constant_wrapper<42U>, constant_wrapper<u'*'>>);
        static_assert(CanGreater<constant_wrapper<42UL>, constant_wrapper<u'~'>>);
        static_assert(CanGreater<constant_wrapper<42>, float>);
        static_assert(CanGreater<double, constant_wrapper<84.0F>>);
        static_assert(CanGreater<constant_wrapper<1234.5>, constant_wrapper<123.0L>>);
        static_assert(!CanGreater<constant_wrapper<i_mut_array>, char>);
        static_assert(!CanGreater<int, constant_wrapper<nullptr>>);
        static_assert(!CanGreater<constant_wrapper<i_array>, constant_wrapper<noop_fun>>);
        static_assert(CanGreater<constant_wrapper<i_array>, const int*>);
        static_assert(CanGreater<const int*, constant_wrapper<i_array>>);
        static_assert(CanGreater<const int*, constant_wrapper<i_array + 1>>);
        static_assert(CanGreater<constant_wrapper<i_array>, constant_wrapper<i_array + 1>>);
        static_assert(CanGreater<constant_wrapper<i_array>, constant_wrapper<i_array>>);
        static_assert(CanGreater<constant_wrapper<i_array + 1>, constant_wrapper<i_array>>);
        static_assert(CanGreater<constant_wrapper<S{-17}>, constant_wrapper<S{29}>>);
        static_assert(CanGreater<constant_wrapper<S{94}>, constant_wrapper<S{94}>>);
        static_assert(CanGreater<constant_wrapper<S{1729}>, constant_wrapper<S{42}>>);
        static_assert(CanGreater<constant_wrapper<-17>, constant_wrapper<S{29}>>);
        static_assert(CanGreater<constant_wrapper<94>, constant_wrapper<S{94}>>);
        static_assert(CanGreater<constant_wrapper<1729>, constant_wrapper<S{42}>>);
        static_assert(CanGreater<constant_wrapper<S{-17}>, constant_wrapper<29>>);
        static_assert(CanGreater<constant_wrapper<S{94}>, constant_wrapper<94>>);
        static_assert(CanGreater<constant_wrapper<S{1729}>, constant_wrapper<42>>);
        ...
        [[maybe_unused]] same_as<constant_wrapper<false>> decltype(auto) cw3 = cw<i_array> > cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw4  = cw<i_array + 1> > cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<S::Greater{false}>> decltype(auto) cw5 = cw<S{-17}> > cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::Greater{false}>> decltype(auto) cw6 = cw<S{94}> > cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::Greater{true}>> decltype(auto) cw7  = cw<S{1729}> > cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterLeftInt{false}>> decltype(auto) cw8 = cw<-17> > cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterLeftInt{false}>> decltype(auto) cw9 = cw<94> > cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterLeftInt{true}>> decltype(auto) cw10 = cw<1729> > cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterRightInt{false}>> decltype(auto) cw11 = cw<S{-17}> > cw<29>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterRightInt{false}>> decltype(auto) cw12 = cw<S{94}> > cw<94>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterRightInt{true}>> decltype(auto) cw13 = cw<S{1729}> > cw<42>;
    }

    // operator>=
    {
        static_assert(CanGreaterEqual<constant_wrapper<u'\u0000'>, unsigned int>);
        static_assert(CanGreaterEqual<constant_wrapper<u'*'>, unsigned short>);
        static_assert(CanGreaterEqual<constant_wrapper<u'~'>, unsigned long long>);
        static_assert(CanGreaterEqual<unsigned char, constant_wrapper<u'\u0000'>>);
        static_assert(CanGreaterEqual<unsigned int, constant_wrapper<u'*'>>);
        static_assert(CanGreaterEqual<unsigned long, constant_wrapper<u'~'>>);
        static_assert(CanGreaterEqual<constant_wrapper<u'\u0000'>, constant_wrapper<42U>>);
        static_assert(CanGreaterEqual<constant_wrapper<u'*'>, constant_wrapper<static_cast<unsigned short>(42U)>>);
        static_assert(CanGreaterEqual<constant_wrapper<u'~'>, constant_wrapper<42ULL>>);
        static_assert(CanGreaterEqual<constant_wrapper<static_cast<unsigned char>(42U)>, constant_wrapper<u'\u0000'>>);
        static_assert(CanGreaterEqual<constant_wrapper<42U>, constant_wrapper<u'*'>>);
        static_assert(CanGreaterEqual<constant_wrapper<42UL>, constant_wrapper<u'~'>>);
        static_assert(CanGreaterEqual<constant_wrapper<42>, float>);
        static_assert(CanGreaterEqual<double, constant_wrapper<84.0F>>);
        static_assert(CanGreaterEqual<constant_wrapper<1234.5>, constant_wrapper<123.0L>>);
        static_assert(!CanGreaterEqual<constant_wrapper<i_mut_array>, char>);
        static_assert(!CanGreaterEqual<int, constant_wrapper<nullptr>>);
        static_assert(!CanGreaterEqual<constant_wrapper<i_array>, constant_wrapper<noop_fun>>);
        static_assert(CanGreaterEqual<constant_wrapper<i_array>, const int*>);
        static_assert(CanGreaterEqual<const int*, constant_wrapper<i_array>>);
        static_assert(CanGreaterEqual<const int*, constant_wrapper<i_array + 1>>);
        static_assert(CanGreaterEqual<constant_wrapper<i_array>, constant_wrapper<i_array + 1>>);
        static_assert(CanGreaterEqual<constant_wrapper<i_array>, constant_wrapper<i_array>>);
        static_assert(CanGreaterEqual<constant_wrapper<i_array + 1>, constant_wrapper<i_array>>);
        static_assert(CanGreaterEqual<constant_wrapper<S{-17}>, constant_wrapper<S{29}>>);
        static_assert(CanGreaterEqual<constant_wrapper<S{94}>, constant_wrapper<S{94}>>);
        static_assert(CanGreaterEqual<constant_wrapper<S{1729}>, constant_wrapper<S{42}>>);
        static_assert(CanGreaterEqual<constant_wrapper<-17>, constant_wrapper<S{29}>>);
        static_assert(CanGreaterEqual<constant_wrapper<94>, constant_wrapper<S{94}>>);
        static_assert(CanGreaterEqual<constant_wrapper<1729>, constant_wrapper<S{42}>>);
        static_assert(CanGreaterEqual<constant_wrapper<S{-17}>, constant_wrapper<29>>);
        static_assert(CanGreaterEqual<constant_wrapper<S{94}>, constant_wrapper<94>>);
        static_assert(CanGreaterEqual<constant_wrapper<S{1729}>, constant_wrapper<42>>);
        ...
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw3  = cw<i_array> >= cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<true>> decltype(auto) cw4  = cw<i_array + 1> >= cw<i_array>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterEqual{false}>> decltype(auto) cw5 = cw<S{-17}> >= cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterEqual{true}>> decltype(auto) cw6  = cw<S{94}> >= cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterEqual{true}>> decltype(auto) cw7 = cw<S{1729}> >= cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterEqualLeftInt{false}>> decltype(auto) cw8 =
            cw<-17> >= cw<S{29}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterEqualLeftInt{true}>> decltype(auto) cw9 =
            cw<94> >= cw<S{94}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterEqualLeftInt{true}>> decltype(auto) cw10 =
            cw<1729> >= cw<S{42}>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterEqualRightInt{false}>> decltype(auto) cw11 =
            cw<S{-17}> >= cw<29>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterEqualRightInt{true}>> decltype(auto) cw12 =
            cw<S{94}> >= cw<94>;
        [[maybe_unused]] same_as<constant_wrapper<S::GreaterEqualRightInt{true}>> decltype(auto) cw13 =
            cw<S{1729}> >= cw<42>;
    }
    ...
    // operator, (deleted)
    {
        ...
        static_assert(is_same_v<decltype(cw<'*'>, 0), int>);
        static_assert(is_same_v<decltype((S{}, cw<nullptr>) ), const constant_wrapper<nullptr>&>);
    }
    ...
    // operator()
    {
        static_assert(is_nothrow_invocable_v<constant_wrapper<PlusNoexcept{}>, int, int>);
        static_assert(is_nothrow_invocable_v<constant_wrapper<PlusNoexcept{}>, constant_wrapper<42>, int>);
        static_assert(is_nothrow_invocable_v<constant_wrapper<PlusNoexcept{}>, int, constant_wrapper<17>>);
        static_assert(
            is_nothrow_invocable_v<constant_wrapper<PlusNoexcept{}>, constant_wrapper<42>, constant_wrapper<17>>);
        static_assert(is_invocable_v<constant_wrapper<PlusYesexcept{}>, int, int>);
        static_assert(is_invocable_v<constant_wrapper<PlusYesexcept{}>, constant_wrapper<42>, int>);
        static_assert(is_invocable_v<constant_wrapper<PlusYesexcept{}>, int, constant_wrapper<17>>);
#ifndef __EDG__
        static_assert(
            is_nothrow_invocable_v<constant_wrapper<PlusYesexcept{}>, constant_wrapper<42>, constant_wrapper<17>>);
#endif
        static_assert(!is_invocable_v<constant_wrapper<PlusNoexcept{}>>);
        static_assert(!is_invocable_v<constant_wrapper<PlusNoexcept{}>, int, nullptr_t>);
        static_assert(!is_invocable_v<constant_wrapper<PlusNoexcept{}>, constant_wrapper<42>, void (*)()>);
        static_assert(
            !is_invocable_v<constant_wrapper<PlusNoexcept{}>, constant_wrapper<noop_fun>, constant_wrapper<i_array>>);
        static_assert(!is_invocable_v<constant_wrapper<PlusNoexcept{}>, constant_wrapper<42>, constant_wrapper<17>,
            constant_wrapper<29>>);
        static_assert(is_invocable_v<constant_wrapper<noop_fun>>);
        static_assert(!is_invocable_v<constant_wrapper<noop_fun>, int>);
        static_assert(is_nothrow_invocable_v<constant_wrapper<noop_noexcept_fun>>);
        static_assert(!is_invocable_v<constant_wrapper<noop_noexcept_fun>, double>);

        static_assert(!noexcept(cw<PlusYesexcept{}>(42, 17)));
        static_assert(!noexcept(cw<PlusYesexcept{}>(cw<42>, 17)));
        static_assert(!noexcept(cw<PlusYesexcept{}>(42, cw<17>)));
        static_assert(!noexcept(cw<noop_fun>()));

        static_assert(is_same_v<void, decltype(cw<noop_fun>())>);
        static_assert(is_same_v<void, decltype(cw<noop_noexcept_fun>())>);

        same_as<int> decltype(auto) v1 = cw<PlusNoexcept{}>(42, 17);
        same_as<int> decltype(auto) v2 = cw<PlusNoexcept{}>(cw<42>, 17);
        same_as<int> decltype(auto) v3 = cw<PlusNoexcept{}>(42, cw<17>);
        same_as<int> decltype(auto) v4 = cw<PlusYesexcept{}>(42, 17);
        same_as<int> decltype(auto) v5 = cw<PlusYesexcept{}>(cw<42>, 17);
        same_as<int> decltype(auto) v6 = cw<PlusYesexcept{}>(42, cw<17>);
        ...
        [[maybe_unused]] same_as<constant_wrapper<59>> decltype(auto) cw1 = cw<PlusNoexcept{}>(cw<42>, cw<17>);
        [[maybe_unused]] same_as<constant_wrapper<59>> decltype(auto) cw2 = cw<PlusYesexcept{}>(cw<42>, cw<17>);
#ifndef __EDG__
        [[maybe_unused]] same_as<constant_wrapper<ReturnTypeTester::InvocationResult<int>{}>> decltype(auto) cw3 =
            cw<ReturnTypeTester{}>(cw<1729>);
#endif
    }

    // operator[]
    {
#ifdef __EDG__ // TRANSITION, fixed in EDG 6.9
        using ArrayYesexcept = ::ArrayYesexcept<char, 8>;
#endif // ^^^ workaround ^^^
        static_assert(CanSubscript<constant_wrapper<i_array>, unsigned int>);
        static_assert(CanSubscript<const int (&)[1], constant_wrapper<0U>>);
        static_assert(CanSubscript<constant_wrapper<i_array>, constant_wrapper<0U>>);
        static_assert(CanSubscript<constant_wrapper<0L>, constant_wrapper<i_array>>);
        static_assert(!CanSubscript<long, constant_wrapper<noop_noexcept_fun>>);
        static_assert(!CanSubscript<constant_wrapper<3ULL>, long long>);
        static_assert(!CanSubscript<constant_wrapper<nullptr>, constant_wrapper<0U>>);
#ifndef __EDG__ // TRANSITION, DevCom-11151544
        static_assert(CanSubscript<constant_wrapper<ArrayNoexcept{"literal"}>, int>);
#endif // ^^^ no workaround ^^^
        static_assert(CanSubscript<constant_wrapper<ArrayNoexcept{"literal"}>, constant_wrapper<3U>>);
        static_assert(!CanSubscript<constant_wrapper<4UL>, constant_wrapper<ArrayNoexcept{"literal"}>>);
        static_assert(!CanSubscript<constant_wrapper<ArrayNoexcept{"literal"}>>);
        static_assert(!CanSubscript<constant_wrapper<ArrayNoexcept{"literal"}>, nullptr_t>);
        static_assert(!CanSubscript<constant_wrapper<ArrayNoexcept{"literal"}>, constant_wrapper<i_array>>);
        static_assert(!CanSubscript<constant_wrapper<ArrayNoexcept{"literal"}>, int, long>);
        static_assert(
            !CanSubscript<constant_wrapper<ArrayNoexcept{"literal"}>, constant_wrapper<5.0F>, constant_wrapper<6.0L>>);
#ifndef __EDG__ // TRANSITION, DevCom-11151544
        static_assert(CanSubscript<constant_wrapper<ArrayYesexcept{"literal"}>, int>);
#endif // ^^^ no workaround ^^^
        static_assert(CanSubscript<constant_wrapper<ArrayYesexcept{"literal"}>, constant_wrapper<3U>>);
        static_assert(!CanSubscript<constant_wrapper<4UL>, constant_wrapper<ArrayYesexcept{"literal"}>>);
        static_assert(!CanSubscript<constant_wrapper<ArrayYesexcept{"literal"}>>);
        static_assert(!CanSubscript<constant_wrapper<ArrayYesexcept{"literal"}>, nullptr_t>);
        static_assert(!CanSubscript<constant_wrapper<ArrayYesexcept{"literal"}>, constant_wrapper<i_array>>);
        static_assert(!CanSubscript<constant_wrapper<ArrayYesexcept{"literal"}>, int, long>);
        static_assert(
            !CanSubscript<constant_wrapper<ArrayYesexcept{"literal"}>, constant_wrapper<5.0F>, constant_wrapper<6.0L>>);

        static_assert(noexcept(cw<i_array>[0U]));
        static_assert(noexcept(i_array[cw<0U>]));
        static_assert(noexcept(cw<i_array>[cw<0U>]));
#ifndef __EDG__ // TRANSITION, DevCom-11151544
        static_assert(noexcept(cw<ArrayNoexcept{"literal"}>[1]));
#endif // ^^^ no workaround ^^^
        static_assert(noexcept(cw<ArrayNoexcept{"literal"}>[cw<3U>]));
#ifndef __EDG__ // TRANSITION, DevCom-11151544
        static_assert(!noexcept(cw<ArrayYesexcept{"literal"}>[1]));
#endif // ^^^ no workaround ^^^
        static_assert(noexcept(cw<ArrayYesexcept{"literal"}>[cw<3U>]));

        constexpr const auto& array_noexcept_constant  = template_parameter_object_of<ArrayNoexcept{"literal"}>;
        constexpr const auto& array_yesexcept_constant = template_parameter_object_of<ArrayYesexcept{"literal"}>;

        same_as<const int&> decltype(auto) v1 = cw<i_array>[0U];
        same_as<const int&> decltype(auto) v2 = i_array[cw<0U>];
#ifndef __EDG__ // TRANSITION, DevCom-11151544
        same_as<const char&> decltype(auto) v3 = cw<ArrayNoexcept{"literal"}>[1];
        same_as<const char&> decltype(auto) v4 = cw<ArrayYesexcept{"literal"}>[1];
#endif // ^^^ no workaround ^^^

        assert(addressof(v1) == i_array + 0 && v1 == 172);
        assert(addressof(v2) == i_array + 0 && v2 == 172);
#ifndef __EDG__ // TRANSITION, DevCom-11151544
        assert(addressof(v3) == array_noexcept_constant.elems_ + 1 && v3 == 'i');
        assert(addressof(v4) == array_yesexcept_constant.elems_ + 1 && v3 == 'i');
#endif // ^^^ no workaround ^^^

        [[maybe_unused]] same_as<constant_wrapper<172>> decltype(auto) cw1 = cw<i_array>[cw<0u>];
        [[maybe_unused]] same_as<constant_wrapper<172>> decltype(auto) cw2 = cw<0L>[cw<i_array>];
        [[maybe_unused]] same_as<constant_wrapper<'e'>> decltype(auto) cw3 = cw<ArrayNoexcept{"literal"}>[cw<3U>];
        [[maybe_unused]] same_as<constant_wrapper<'e'>> decltype(auto) cw4 = cw<ArrayYesexcept{"literal"}>[cw<3U>];
        [[maybe_unused]] same_as<constant_wrapper<ReturnTypeTester::SubscriptResult<int>{}>> decltype(auto) cw5 =
            cw<ReturnTypeTester{}>[cw<1729>];
    }
...
void test_nonconstexpr() {
    // When results of operations between constant_wrapper<T>::value fails to be constant, constant_wrapper's operators
    // should be excluded from overload resolution, and operator decltype(value) should be called to perform underlying
    // non-constant operations.

    using AdlTest3::NonConst;

    same_as<NonConst::UnaryPlus> decltype(auto) v1       = +cw<NonConst{42}>;
    same_as<NonConst::UnaryMinus> decltype(auto) v2      = -cw<NonConst{17}>;
    same_as<NonConst::Complement> decltype(auto) v3      = ~cw<NonConst{172}>;
    same_as<NonConst::Negate> decltype(auto) v4          = !cw<NonConst{72}>;
    same_as<NonConst::DerefCopy> decltype(auto) v5       = *cw<NonConst{421}>;
    same_as<NonConst::UnaryAnd> decltype(auto) v6        = &cw<NonConst{128}>;
    same_as<NonConst::Plus> decltype(auto) v7            = cw<NonConst{42}> + cw<NonConst{-17}>;
    same_as<NonConst::Minus> decltype(auto) v8           = cw<NonConst{172}> - cw<NonConst{729}>;
    same_as<NonConst::Multiply> decltype(auto) v9        = cw<NonConst{542}> * cw<NonConst{-13}>;
    same_as<NonConst::Divide> decltype(auto) v10         = cw<NonConst{5217}> / cw<NonConst{429}>;
    same_as<NonConst::Modulo> decltype(auto) v11         = cw<NonConst{232}> % cw<NonConst{17}>;
    same_as<NonConst::Shl> decltype(auto) v12            = cw<NonConst{-126}> << cw<NonConst{3}>;
    same_as<NonConst::Shr> decltype(auto) v13            = cw<NonConst{-1729}> >> cw<NonConst{3}>;
    same_as<NonConst::BitAnd> decltype(auto) v14         = cw<NonConst{-1729}> & cw<NonConst{42}>;
    same_as<NonConst::BitOr> decltype(auto) v15          = cw<NonConst{42}> | cw<NonConst{172}>;
    same_as<NonConst::Xor> decltype(auto) v16            = cw<NonConst{123}> ^ cw<NonConst{456}>;
    same_as<NonConst::LogicalAnd> decltype(auto) v17     = cw<NonConst{0}> && cw<NonConst{128}>;
    same_as<NonConst::LogicalOr> decltype(auto) v18      = cw<NonConst{127}> || cw<NonConst{0}>;
    same_as<NonConst::ThreeWayCmp> decltype(auto) v19    = cw<NonConst{5780}> <=> cw<NonConst{1729}>;
    same_as<NonConst::Less> decltype(auto) v20           = cw<NonConst{-126}> < cw<NonConst{3}>;
    same_as<NonConst::LessEqual> decltype(auto) v21      = cw<NonConst{-1729}> <= cw<NonConst{3}>;
    same_as<NonConst::Equal> decltype(auto) v22          = cw<NonConst{-1729}> == cw<NonConst{42}>;
    same_as<NonConst::Unequal> decltype(auto) v23        = cw<NonConst{42}> != cw<NonConst{172}>;
    same_as<NonConst::Greater> decltype(auto) v24        = cw<NonConst{123}> > cw<NonConst{456}>;
    same_as<NonConst::GreaterEqual> decltype(auto) v25   = cw<NonConst{0}> >= cw<NonConst{128}>;
    same_as<NonConst::ArrowStar> decltype(auto) v26      = cw<NonConst{42}>->*cw<NonConst{-17}>;
    same_as<NonConst::PreInc> decltype(auto) v27         = ++cw<NonConst{123}>;
    same_as<NonConst::PostInc> decltype(auto) v28        = cw<NonConst{234}> ++;
    same_as<NonConst::PreDec> decltype(auto) v29         = --cw<NonConst{345}>;
    same_as<NonConst::PostDec> decltype(auto) v30        = cw<NonConst{456}> --;
    same_as<NonConst::PlusAssign> decltype(auto) v31     = cw<NonConst{42}> += cw<NonConst{-17}>;
    same_as<NonConst::MinusAssign> decltype(auto) v32    = cw<NonConst{172}> -= cw<NonConst{729}>;
    same_as<NonConst::MultiplyAssign> decltype(auto) v33 = cw<NonConst{542}> *= cw<NonConst{-13}>;
    same_as<NonConst::DivideAssign> decltype(auto) v34   = cw<NonConst{5217}> /= cw<NonConst{429}>;
    same_as<NonConst::ModuloAssign> decltype(auto) v35   = cw<NonConst{232}> %= cw<NonConst{17}>;
    same_as<NonConst::BitAndAssign> decltype(auto) v36   = cw<NonConst{-1729}> &= cw<NonConst{42}>;
    same_as<NonConst::BitOrAssign> decltype(auto) v37    = cw<NonConst{42}> |= cw<NonConst{172}>;
    same_as<NonConst::XorAssign> decltype(auto) v38      = cw<NonConst{123}> ^= cw<NonConst{456}>;
    same_as<NonConst::ShlAssign> decltype(auto) v39      = cw<NonConst{-126}> <<= cw<NonConst{3}>;
    same_as<NonConst::ShrAssign> decltype(auto) v40      = cw<NonConst{-1729}> >>= cw<NonConst{3}>;
    same_as<NonConst::Plus> decltype(auto) v41           = cw<PlusNoexcept{}>(cw<NonConst{42}>, cw<NonConst{1729}>);
    same_as<NonConst::Plus> decltype(auto) v42           = cw<PlusYesexcept{}>(cw<NonConst{421}>, cw<NonConst{729}>);
    same_as<int&> decltype(auto) v43                     = *cw<i_mut_array>;
#ifndef __EDG__ // TRANSITION, DevCom-11151544
    same_as<int&> decltype(auto) v44 = cw<i_mut_array>[cw<0U>];
#endif // ^^^ no workaround ^^^

    static_assert(!noexcept(+cw<NonConst{42}>));
    static_assert(!noexcept(-cw<NonConst{17}>));
    static_assert(!noexcept(~cw<NonConst{172}>));
    static_assert(!noexcept(!cw<NonConst{72}>));
    static_assert(!noexcept(*cw<NonConst{421}>));
    static_assert(!noexcept(&cw<NonConst{128}>));
    static_assert(!noexcept(cw<NonConst{42}> + cw<NonConst{-17}>));
    static_assert(!noexcept(cw<NonConst{172}> - cw<NonConst{729}>));
    static_assert(!noexcept(cw<NonConst{542}> * cw<NonConst{-13}>));
    static_assert(!noexcept(cw<NonConst{5217}> / cw<NonConst{429}>));
    static_assert(!noexcept(cw<NonConst{232}> % cw<NonConst{17}>));
    static_assert(!noexcept(cw<NonConst{-126}> << cw<NonConst{3}>));
    static_assert(!noexcept(cw<NonConst{-1729}> >> cw<NonConst{3}>));
    static_assert(!noexcept(cw<NonConst{-1729}> & cw<NonConst{42}>));
    static_assert(!noexcept(cw<NonConst{42}> | cw<NonConst{172}>));
    static_assert(!noexcept(cw<NonConst{123}> ^ cw<NonConst{456}>));
    static_assert(!noexcept(cw<NonConst{0}> && cw<NonConst{128}>));
    static_assert(!noexcept(cw<NonConst{127}> || cw<NonConst{0}>));
    static_assert(!noexcept(cw<NonConst{5780}> <=> cw<NonConst{1729}>));
    static_assert(!noexcept(cw<NonConst{-126}> < cw<NonConst{3}>));
    static_assert(!noexcept(cw<NonConst{-1729}> <= cw<NonConst{3}>));
    static_assert(!noexcept(cw<NonConst{-1729}> == cw<NonConst{42}>));
    static_assert(!noexcept(cw<NonConst{42}> != cw<NonConst{172}>));
    ...
    static_assert(!noexcept(cw<NonConst{0}> >= cw<NonConst{128}>));
    static_assert(!noexcept(cw<NonConst{42}>->*cw<NonConst{-17}>));
    static_assert(!noexcept(++cw<NonConst{123}>));
    static_assert(!noexcept(cw<NonConst{234}> ++));
    static_assert(!noexcept(--cw<NonConst{345}>));
    static_assert(!noexcept(cw<NonConst{456}> --));
    static_assert(!noexcept(cw<NonConst{42}> += cw<NonConst{-17}>));
    static_assert(!noexcept(cw<NonConst{172}> -= cw<NonConst{729}>));
    static_assert(!noexcept(cw<NonConst{542}> *= cw<NonConst{-13}>));
    static_assert(!noexcept(cw<NonConst{5217}> /= cw<NonConst{429}>));
    ...
    static_assert(!noexcept(cw<NonConst{-126}> <<= cw<NonConst{3}>));
    static_assert(!noexcept(cw<NonConst{-1729}> >>= cw<NonConst{3}>));
    static_assert(noexcept(cw<PlusNoexcept{}>(cw<NonConst{42}>, cw<NonConst{1729}>)));
    static_assert(!noexcept(cw<PlusYesexcept{}>(cw<NonConst{421}>, cw<NonConst{729}>)));
    ...
    assert(!v4.res_);
    assert(v5.res_ = 421);
    assert(v6.ptr_ == &template_parameter_object_of<NonConst{128}>.val_);
    assert(v7.res_ == 25);
    assert(v8.res_ == -557);
    assert(v9.res_ == -7046);
    assert(v10.res_ == 12);
    assert(v11.res_ == 11);
    assert(v12.res_ == -1008);
    assert(v13.res_ == -217);
    assert(v14.res_ == 42);
    assert(v15.res_ == 174);
    assert(v16.res_ == 435);
    assert(!v17.res_);
    assert(v18.res_);
    assert(v19.res_ == strong_ordering::greater);
    assert(v20.res_);
    assert(v21.res_);
    assert(!v22.res_);
    assert(v23.res_);
    ...
    assert(v31.res_ == 25);
    assert(v32.res_ == -557);
    assert(v33.res_ == -7046);
    assert(v34.res_ == 12);
    assert(v35.res_ == 11);
    assert(v36.res_ == 42);
    assert(v37.res_ == 174);
    assert(v38.res_ == 435);
    assert(v39.res_ == -1008);
    assert(v40.res_ == -217);
    assert(v41.res_ == 1771);
    assert(v42.res_ == 1150);
    assert(&v43 == i_mut_array);
#ifndef __EDG__ // TRANSITION, DevCom-11151544
    assert(&v44 == i_mut_array);
#endif // ^^^ no workaround ^^^
}

void test_ub() { // COMPILE-ONLY
    // These cases have undefined behavior and thus should not be executed.
...
#ifdef __clang__ // TRANSITION, DevCom-11143158 (MSVC), DevCom-11153209 (EDG)
    [[maybe_unused]] same_as<int> decltype(auto) ub1 = -cw<int_min>;
#endif // ^^^ no workaround ^^^
    [[maybe_unused]] same_as<int> decltype(auto) ub2 = cw<int_max> + cw<42>;
    [[maybe_unused]] same_as<int> decltype(auto) ub3 = cw<int_min> - cw<1729>;
    [[maybe_unused]] same_as<int> decltype(auto) ub4 = cw<int_max> * cw<42>;
    [[maybe_unused]] same_as<int> decltype(auto) ub5 = cw<int_min> / cw<-1>;
    [[maybe_unused]] same_as<int> decltype(auto) ub6 = cw<42> / cw<0>;
#ifndef __EDG__ // TRANSITION, DevCom-11153209
    [[maybe_unused]] same_as<int> decltype(auto) ub7 = cw<int_min> % cw<-1>;
#endif // ^^^ no workaround ^^^
#ifndef __EDG__
    [[maybe_unused]] same_as<unsigned int> decltype(auto) ub8 = cw<42u> << cw<numeric_limits<unsigned int>::digits>;
    [[maybe_unused]] same_as<unsigned int> decltype(auto) ub9 = cw<42u> >> cw<numeric_limits<unsigned int>::digits>;
#endif // ^^^ no workaround ^^^
    [[maybe_unused]] same_as<unsigned int> decltype(auto) ub10 = cw<42u> << cw<-1>;
    [[maybe_unused]] same_as<unsigned int> decltype(auto) ub11 = cw<42u> >> cw<-1>;

    [[maybe_unused]] same_as<int&> decltype(auto) ub12 = *cw<static_cast<int*>(nullptr)>;
#ifndef __EDG__
    [[maybe_unused]] same_as<int*> decltype(auto) ub13 = cw<static_cast<int*>(nullptr)> + cw<2U>;
#endif
    [[maybe_unused]] same_as<long*> decltype(auto) ub14 = cw<static_cast<long*>(nullptr)> - cw<2>;
    [[maybe_unused]] same_as<int> decltype(auto) ub15   = cw<static_cast<int (*)(int)>(nullptr)>(cw<1729>);
#ifndef __EDG__
    [[maybe_unused]] same_as<const char&> decltype(auto) ub16 = cw<static_cast<const char*>(nullptr)>[cw<1LL>];
#endif
    [[maybe_unused]] same_as<const int&> decltype(auto) ub17 = cw<i_array>[cw<42L>];

    [[maybe_unused]] same_as<S::ArrowStar> decltype(auto) ub18      = cw<S{int_max}>->*cw<S{int_min}>;
    [[maybe_unused]] same_as<S::PreInc> decltype(auto) ub19         = ++cw<S{int_max}>;
    [[maybe_unused]] same_as<S::PostInc> decltype(auto) ub20        = cw<S{int_max}> ++;
    [[maybe_unused]] same_as<S::PreDec> decltype(auto) ub21         = --cw<S{int_min}>;
    [[maybe_unused]] same_as<S::PostDec> decltype(auto) ub22        = cw<S{int_min}> --;
    [[maybe_unused]] same_as<S::PlusAssign> decltype(auto) ub23     = cw<S{int_max}> += cw<S{42}>;
    [[maybe_unused]] same_as<S::MinusAssign> decltype(auto) ub24    = cw<S{int_min}> -= cw<S{1729}>;
    [[maybe_unused]] same_as<S::MultiplyAssign> decltype(auto) ub25 = cw<S{int_max}> *= cw<S{42}>;
#ifndef __EDG__ // TRANSITION, DevCom-11153209
    [[maybe_unused]] same_as<S::DivideAssign> decltype(auto) ub26 = cw<S{int_min}> /= cw<S{-1}>;
#endif // ^^^ workaround ^^^
    [[maybe_unused]] same_as<S::DivideAssign> decltype(auto) ub27 = cw<S{42}> /= cw<S{0}>;
#ifndef __EDG__ // TRANSITION, DevCom-11153209
    [[maybe_unused]] same_as<S::ModuloAssign> decltype(auto) ub28 = cw<S{int_min}> %= cw<S{-1}>;
#endif // ^^^ workaround ^^^
    [[maybe_unused]] same_as<S::ShlAssign> decltype(auto) ub29 = cw<S{42}> <<=
        cw<S{numeric_limits<unsigned int>::digits}>;
    [[maybe_unused]] same_as<S::ShrAssign> decltype(auto) ub30 = cw<S{42}> >>=
        cw<S{numeric_limits<unsigned int>::digits}>;
    [[maybe_unused]] same_as<S::ShlAssignRightInt> decltype(auto) ub31 = cw<S{42}> <<= cw<-1>;
    [[maybe_unused]] same_as<S::ShrAssignRightInt> decltype(auto) ub32 = cw<S{42}> >>= cw<-1>;

    [[maybe_unused]] same_as<int> decltype(auto) ub33 = cw<PlusNoexcept{}>(cw<int_max>, cw<1729>);
    [[maybe_unused]] same_as<int> decltype(auto) ub34 = cw<PlusYesexcept{}>(cw<int_min>, cw<-42>);

    static_assert(!noexcept(cw<S{int_max}>->*cw<S{int_min}>));
    static_assert(!noexcept(++cw<S{int_max}>));
    static_assert(!noexcept(cw<S{int_max}> ++));
    static_assert(!noexcept(--cw<S{int_min}>));
    static_assert(!noexcept(cw<S{int_min}> --));
    static_assert(!noexcept(cw<S{int_max}> += cw<S{42}>));
    static_assert(!noexcept(cw<S{int_min}> -= cw<S{1729}>));
    static_assert(!noexcept(cw<S{int_max}> *= cw<S{42}>));
#ifndef __EDG__ // TRANSITION, DevCom-11153209
    static_assert(!noexcept(cw<S{int_min}> /= cw<S{-1}>));
#endif // ^^^ workaround ^^^
    static_assert(!noexcept(cw<S{42}> /= cw<S{0}>));
#ifndef __EDG__ // TRANSITION, DevCom-11153209
    static_assert(!noexcept(cw<S{int_min}> %= cw<S{-1}>));
#endif // ^^^ workaround ^^^
    static_assert(!noexcept(cw<S{42}> <<= cw<S{numeric_limits<unsigned int>::digits}>));
    static_assert(!noexcept(cw<S{42}> >>= cw<S{numeric_limits<unsigned int>::digits}>));
    static_assert(!noexcept(cw<S{42}> <<= cw<-1>));
    static_assert(!noexcept(cw<S{42}> >>= cw<-1>));
    static_assert(noexcept(cw<PlusNoexcept{}>(cw<int_max>, cw<1729>)));
    static_assert(!noexcept(cw<PlusYesexcept{}>(cw<int_min>, cw<-42>)));
...
void test_miscelleneous() { // COMPILE-ONLY
    ...
    static_assert(!CanThreeWay<constant_wrapper<NoOperation{}>, constant_wrapper<NoOperation{}>>);
    ...
    static_assert(!is_assignable_v<const constant_wrapper<NoOperation{}>&, const constant_wrapper<NoOperation{}>&>);
    static_assert(!is_invocable_v<constant_wrapper<NoOperation{}>>);
    static_assert(!is_invocable_v<constant_wrapper<NoOperation{}>, constant_wrapper<NoOperation{}>>);
    static_assert(!is_invocable_v<constant_wrapper<NoOperation{}>, NoOperation>);
