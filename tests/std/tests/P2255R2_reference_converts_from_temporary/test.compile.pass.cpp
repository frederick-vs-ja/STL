...
void test_to_int_ref() {
    static_assert(!reference_converts_from_temporary<int&, to_int_lvalue<conv_explicity::yes>>::value);

    static_assert(!reference_converts_from_temporary_v<int&, to_int_lvalue<conv_explicity::yes>>);
    static_assert(!reference_converts_from_temporary_v<const int&, to_int_lvalue<conv_explicity::yes>>);

    static_assert(!reference_converts_from_temporary_v<const long&, to_int_lvalue<conv_explicity::yes>>);
}
#endif // ^^^ no workaround ^^^
