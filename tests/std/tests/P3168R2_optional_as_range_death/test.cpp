...
template <auto Operation, AddConst LhsConst, AddConst RhsConst>
void test_unrelated_optional_iterators() {
    optional<int> opt1;
    optional<int> opt2;
...
int main(int argc, char* argv[]) {
    ...
    exec.add_death_tests({
        ...
        test_unrelated_optional_iterators<iter_eq, AddConst::No, AddConst::No>,
        test_unrelated_optional_iterators<iter_ne, AddConst::No, AddConst::No>,
        test_unrelated_optional_iterators<iter_lt, AddConst::No, AddConst::No>,
        test_unrelated_optional_iterators<iter_le, AddConst::No, AddConst::No>,
        test_unrelated_optional_iterators<iter_gt, AddConst::No, AddConst::No>,
        test_unrelated_optional_iterators<iter_ge, AddConst::No, AddConst::No>,
        test_unrelated_optional_iterators<iter_3way, AddConst::No, AddConst::No>,
        test_unrelated_optional_iterators<iter_diff, AddConst::No, AddConst::No>,

        test_unrelated_optional_iterators<iter_eq, AddConst::No, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_ne, AddConst::No, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_lt, AddConst::No, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_le, AddConst::No, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_gt, AddConst::No, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_ge, AddConst::No, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_3way, AddConst::No, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_diff, AddConst::No, AddConst::Yes>,

        test_unrelated_optional_iterators<iter_eq, AddConst::Yes, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_ne, AddConst::Yes, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_lt, AddConst::Yes, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_le, AddConst::Yes, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_gt, AddConst::Yes, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_ge, AddConst::Yes, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_3way, AddConst::Yes, AddConst::Yes>,
        test_unrelated_optional_iterators<iter_diff, AddConst::Yes, AddConst::Yes>,
